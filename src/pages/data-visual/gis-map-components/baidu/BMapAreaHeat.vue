<template>
  <div>
    <ul class="dmap-areaheat-panel page-col-ul">
      ...
      setBizFillColor () { // 设置商圈的热力颜色
        if (this.areaPlyData) {
          ...
          Object.values(this.areaPlyData).forEach(bizPly => {
            ...
            bizPly.setFillColor(bizPly.bizStyle.fillColor)
            bizPly.setFillOpacity(bizPly.bizStyle.fillOpacity)
          })
        }
      },
